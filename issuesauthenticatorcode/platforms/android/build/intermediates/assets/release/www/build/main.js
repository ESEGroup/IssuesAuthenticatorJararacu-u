...
var ConfigPage = (function () {
    function ConfigPage(/*private navCtrl: NavController, */ alertCtrl) {
        this.alertCtrl = alertCtrl;
    }
    ConfigPage.prototype.getRouters = function () {
    };
    ConfigPage.prototype.doAlert = function () {
        var alert = this.alertCtrl.create({
...
ConfigPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-config',template:/*ion-inline-start:"/home/jonathan-alcantara/Documents/Projects/Development/IssuesAuthenticatorJararacucu/issuesauthenticatorcode/src/pages/config/config.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Configurações</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n  <ion-list>\n    <ion-list-header>Salas Salvas</ion-list-header>\n    <ion-item (click)="doAlert()">Laboratório H317</ion-item>\n    <ion-item (click)="doAlert()">Laboratório I246</ion-item>\n    <ion-item (click)="doAlert()">Sala do GHT</ion-item>\n  </ion-list>\n\n</ion-content>'/*ion-inline-end:"/home/jonathan-alcantara/Documents/Projects/Development/IssuesAuthenticatorJararacucu/issuesauthenticatorcode/src/pages/config/config.html"*/
    }),
